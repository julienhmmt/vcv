...
var spanishMessages = Messages{
	...
	FilterChipSearch:               "Búsqueda",
	FilterChipStatus:               "Estado",
	FilterChipCertType:             "Tipo",
	FilterChipSources:              "Orígenes",
	FilterChipReset:                "Restablecer filtros",
	SourcesButtonAll:               "Sources: {total}/{total}",
	SourcesButtonPartial:           "Sources: {selected}/{total}",
...
var germanMessages = Messages{
	...
	FilterChipSearch:               "Suche",
	FilterChipStatus:               "Status",
	FilterChipCertType:             "Typ",
	FilterChipSources:              "Quellen",
	FilterChipReset:                "Filter zurücksetzen",
	SourcesButtonAll:               "Sources: {total}/{total}",
	SourcesButtonPartial:           "Sources: {selected}/{total}",
...
var italianMessages = Messages{
	...
	FilterChipSearch:               "Ricerca",
	FilterChipStatus:               "Stato",
	FilterChipCertType:             "Tipo",
	FilterChipSources:              "Sorgenti",
	FilterChipReset:                "Reimposta filtri",
	SourcesButtonAll:               "Sources: {total}/{total}",
	SourcesButtonPartial:           "Sources: {selected}/{total}",
