...
type Messages struct {
	...
	AdminNavThresholds             string `json:"adminNavThresholds"`
	AdminNavMetrics                string `json:"adminNavMetrics"`
	AdminNavCors                   string `json:"adminNavCors"`
	AdminNavVaults                 string `json:"adminNavVaults"`
	AdminMetricsPerCertificateDesc string `json:"adminMetricsPerCertificateDesc"`
	AdminMetricsEnhancedDesc       string `json:"adminMetricsEnhancedDesc"`
	AdminVaultCollapse             string `json:"adminVaultCollapse"`
	AdminVaultExpand               string `json:"adminVaultExpand"`
	...
	AdminRoutedWebhooks              string `json:"adminRoutedWebhooks"`
	AdminRoutedWebhooksHint          string `json:"adminRoutedWebhooksHint"`
	AdminRoutedWebhookURLPlaceholder string `json:"adminRoutedWebhookURLPlaceholder"`
	AdminAddWebhook                  string `json:"adminAddWebhook"`
	AdminRemoveWebhook               string `json:"adminRemoveWebhook"`
}
...
var englishMessages = Messages{
	...
	AdminNavThresholds:             "Thresholds",
	AdminNavMetrics:                "Metrics",
	AdminNavCors:                   "CORS",
	AdminNavVaults:                 "Vaults",
	AdminMetricsPerCertificateDesc: "High cardinality. Enable only if Prometheus is configured for it.",
	AdminMetricsEnhancedDesc:       "Additional gauges and histograms beyond the base set.",
	AdminVaultCollapse:             "Collapse",
	...
	AdminRoutedWebhooks:              "Routed webhooks",
	AdminRoutedWebhooksHint:          "Extra endpoints, each with its own warning/critical filter. URLs stay masked like the main one; blank keeps the stored URL.",
	AdminRoutedWebhookURLPlaceholder: "https://hooks.example.com/...",
	AdminAddWebhook:                  "+ Add webhook",
	AdminRemoveWebhook:               "Remove",
}
...
var frenchMessages = Messages{
	...
	AdminNavThresholds:             "Seuils",
	AdminNavMetrics:                "Métriques",
	AdminNavCors:                   "CORS",
	AdminNavVaults:                 "Vaults",
	AdminMetricsPerCertificateDesc: "Haute cardinalité. Activer uniquement si Prometheus est configuré pour cela.",
	AdminMetricsEnhancedDesc:       "Jauges et histogrammes supplémentaires au-delà de l'ensemble de base.",
	AdminVaultCollapse:             "Réduire",
	...
	AdminRoutedWebhooks:              "Webhooks routés",
	AdminRoutedWebhooksHint:          "Points de terminaison supplémentaires, chacun avec son propre filtre d'avertissement/critique. Les URL restent masquées comme la principale ; vide conserve l'URL enregistrée.",
	AdminRoutedWebhookURLPlaceholder: "https://hooks.example.com/...",
	AdminAddWebhook:                  "+ Ajouter un webhook",
	AdminRemoveWebhook:               "Supprimer",
}
...
var spanishMessages = Messages{
	...
	AdminNavThresholds:             "Umbrales",
	AdminNavMetrics:                "Métricas",
	AdminNavCors:                   "CORS",
	AdminNavVaults:                 "Vaults",
	AdminMetricsPerCertificateDesc: "Alta cardinalidad. Habilítelo solo si Prometheus está configurado para ello.",
	AdminMetricsEnhancedDesc:       "Medidores e histogramas adicionales más allá del conjunto base.",
	AdminVaultCollapse:             "Contraer",
	...
	AdminRoutedWebhooks:              "Webhooks enrutados",
	AdminRoutedWebhooksHint:          "Endpoints adicionales, cada uno con su propio filtro de advertencia/crítico. Las URL permanecen enmascaradas como la principal; en blanco conserva la URL almacenada.",
	AdminRoutedWebhookURLPlaceholder: "https://hooks.example.com/...",
	AdminAddWebhook:                  "+ Añadir webhook",
	AdminRemoveWebhook:               "Eliminar",
}
...
var germanMessages = Messages{
	...
	AdminNavThresholds:             "Schwellenwerte",
	AdminNavMetrics:                "Metriken",
	AdminNavCors:                   "CORS",
	AdminNavVaults:                 "Vaults",
	AdminMetricsPerCertificateDesc: "Hohe Kardinalität. Nur aktivieren, wenn Prometheus dafür konfiguriert ist.",
	AdminMetricsEnhancedDesc:       "Zusätzliche Messgeräte und Histogramme über dem Basissatz.",
	AdminVaultCollapse:             "Einklappen",
	...
	AdminRoutedWebhooks:              "Geroutete Webhooks",
	AdminRoutedWebhooksHint:          "Zusätzliche Endpunkte mit eigenem Warn-/Kritisch-Filter. URLs bleiben wie die Haupt-URL maskiert; leer behält die gespeicherte URL.",
	AdminRoutedWebhookURLPlaceholder: "https://hooks.example.com/...",
	AdminAddWebhook:                  "+ Webhook hinzufügen",
	AdminRemoveWebhook:               "Entfernen",
}
...
var italianMessages = Messages{
	...
	AdminNavThresholds:             "Soglie",
	AdminNavMetrics:                "Metriche",
	AdminNavCors:                   "CORS",
	AdminNavVaults:                 "Vaults",
	AdminMetricsPerCertificateDesc: "Alta cardinalità. Abilitare solo se Prometheus è configurato per questo.",
	AdminMetricsEnhancedDesc:       "Indicatori e istogrammi aggiuntivi oltre al set di base.",
	AdminVaultCollapse:             "Comprimi",
	...
	AdminRoutedWebhooks:              "Webhook instradati",
	AdminRoutedWebhooksHint:          "Endpoint aggiuntivi, ciascuno con il proprio filtro di avviso/critico. Gli URL restano mascherati come quello principale; vuoto mantiene l'URL memorizzato.",
	AdminRoutedWebhookURLPlaceholder: "https://hooks.example.com/...",
	AdminAddWebhook:                  "+ Aggiungi webhook",
	AdminRemoveWebhook:               "Rimuovi",
}
